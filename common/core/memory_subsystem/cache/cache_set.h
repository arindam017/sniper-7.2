...
class CacheSet
{
   ...
   public:
      ...
      void write_line2(UInt32 line_index, UInt32 set_index, IntPtr eip);   //created by arindam to pass writeback information to policy files (required in phc)
      ...
      void insert2(CacheBlockInfo* cache_block_info, Byte* fill_buff, bool* eviction, CacheBlockInfo* evict_block_info, Byte* evict_buff, CacheCntlr *cntlr = NULL, IntPtr eip=0, UInt32 set_index=0);  //sn added by arindam
      ...
      virtual void updateReplacementIndex2(UInt32, UInt32, IntPtr) = 0;

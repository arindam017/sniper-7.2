...
#benchmarks=(bwaves cactusADM lbm leslie libq mcf soplex sphinx)
...
for i in {0..22}
	...
	/home/arindam/Desktop/Sniper/sniper-7.2/parser_files/lru/ultimate_parser_single_core_lru.py /home/arindam/Desktop/Sniper/sniper-7.2/expt_results/without_writeback/LRU_8_hybrid/${benchmarks[i]} 1
